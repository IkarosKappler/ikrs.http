...
public class XMLExampleHandler
	...
	for( int i = 0; i < formData.size(); i++ ) {
		...
		String value_contentDisposition_name     = prm_contentDisposition.getTokenValue( "form-data", "name", true );
		String value_contentDisposition_filename = prm_contentDisposition.getTokenValue( "form-data", "filename", true );
