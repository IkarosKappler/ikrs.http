...
var boxes = new Array(
    new PolyBox( 20, 20, 120, 120 ),
    new PolyBox( 160, 20, 80, 80 ),
    new PolyBox( 260, 20, 80, 80 ),
    new PolyBox( 10, 160, 120, 120 ),
    new PolyBox( 180, 160, 240, 240 )
...
function buildPointSet() {
    ...
    var pointsPerDimension = 6;
    for( var i = 2; i < pointsPerDimension; i++ ) {

	this.vertexSet[i*pointsPerDimension     ] = new Point2D( Math.random() * this.polyCanvas.width, 0 );
	this.vertexSet[i*pointsPerDimension + 1 ] = new Point2D( Math.random() * this.polyCanvas.width, this.polyCanvas.height );
	this.vertexSet[i*pointsPerDimension + 2 ] = new Point2D( 0, Math.random() * this.polyCanvas.height );
	this.vertexSet[i*pointsPerDimension + 3 ] = new Point2D( polyCanvas.width, Math.random() * this.polyCanvas.height );
	...
	this.vertexSet[ leadingPointCount + i * 4 ]     = new Point2D( box.x, box.y );
	this.vertexSet[ leadingPointCount + i * 4 + 1 ] = new Point2D( box.x + box.width, box.y );
	this.vertexSet[ leadingPointCount + i * 4 + 2 ] = new Point2D( box.x, box.y + box.height );
	this.vertexSet[ leadingPointCount + i * 4 + 3 ] = new Point2D( box.x + box.width, box.y + box.height );
...
function generateTriangles() {
	...
	context.fillStyle = "rgb(" + r + ", " + g + ", " + b + ")"; // "rgb(200,200,200)";
